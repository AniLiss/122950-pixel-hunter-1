...
export const game1 = parseHTML(`<button class="back">
...
const options = game1.querySelectorAll(`.game__option`);
const firstAnswers = [...game1.querySelectorAll(`[name=question1]`)];
const secondAnswers = [...game1.querySelectorAll(`[name=question2]`)];
